...
import '../data_source/api/character_api_source.dart' as _i7;
import '../data_source/api/my_api_source.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.CharacterApiSource>(
      () => _i7.CharacterApiSourceAdapter(get<_i8.MyApiSource>()));
  gh.singleton<_i9.AppDatabase>(_i9.AppDatabase());
  gh.singleton<_i8.MyApiSource>(_i8.MyApiSource());
  return get;
}
